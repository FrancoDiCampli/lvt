        ...
        <div class="card-body py-5">
            <form method="POST" action="{{ route('enrollments.store') }}" class="mx-auto" >
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                      <select id="student" name="user_id"  class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
