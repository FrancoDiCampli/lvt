            ...
            <form method="POST" action="{{ route('subjects.store') }}" class="mx-auto" >
                ...
                <div class="md:flex">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                        <select id="course"  onchange="setCode()" name="course_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                      <select id="teacher" onchange="setCode()"  id="" name="user_id"  class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
