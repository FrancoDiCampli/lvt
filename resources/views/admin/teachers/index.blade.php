...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
    ...
    {{-- <div class="mx-2 text-white card bg-gradient-green rounded-sm font-montserrat w-auto flex p-5 justify-between mt-5 items-center">
        <div>
            ...
            <div class="flex flex-col min-h-full">
                ...
                <div class="px-6 py-4 font-montserrat w-auto flex justify-between items-center">
                    ...
                    <div class="w-auto flex justify-between items-center">
                        ...
                        {{-- <span class="hidden lg:block rounded-full text-gray-600 bg-gray-200 px-2 py-1 text-xs font-bold ml-2">Tareas activas</span> --}}
                    </div>
                </div>
            </div>
        </div>
