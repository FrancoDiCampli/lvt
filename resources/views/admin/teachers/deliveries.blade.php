...
@section('content')
    ...
    <div class="md:w-6/12 mx-auto">
        ...
        <button id="order" onclick="toogleOrder()" data-order="" class="relative text-gray-700 flex items-center focus:outline-none">
        ...
        <div class="card w-full my-2  bg-white shadow-lg p-5 border-l-2 border-teal-600 rounded-sm">
            <div class=" w-full  flex justify-end relative">
                <button onclick="toogleFm()" class="focus:outline-none">
                    ...
                    rounded-sm" >
                    <a href="{{route('delivery.show',$delivery->id)}}" class="block py-2">Comments</a>
            ...
            <div class="flex justify-between items-center">
                <div class="text-gray-700">
                    <h1>Alumno: {{$delivery->user->name}}</h1>
                    <h1 class="font-semibold"> {{$delivery->job->subject->name}}</h1>
                <h3><a href="{{route('teacher.delivery',$delivery->id)}}">{{$delivery->job->title}}</a> </h3>
