        ...
        <div class="card w-full  bg-white shadow-lg p-5 border-l-2 border-teal-600 rounded-sm">
            <div class=" w-full  flex justify-end relative">
                <button onclick="toogleFm()" class="focus:outline-none">
                    ...
                    rounded-sm" >
                        <a href="" class="block py-2">Option A</a>
            ...
            <div class="flex justify-between items-center">
                <div class="text-gray-700">
                    <h1 class="font-semibold">Matematica</h1>
                    <h3>Limite</h3>
                    <p class="italic">Fecha de entrega <span>11-06</span> </p>
                </div>
                <div>
                    <button class="bg-red-600 rounded-full text-white py-1 px-5">Estado</button>
                </div>
            </div>
