...
<div class="container font-montserrat">
    <div class="card  rounded-sm bg-gray-100 mx-auto mt-10 shadow-lg">
        ...
        <a href="{{route('courses.create')}}" class="bg-teal-600 text-white text-sm p-2 shadow-lg hover:text-gray-700">New Course</a>
            ...
            <table class="text-gray-700">
                <thead>
                    <tr class="text-center">
                        <th class="w-1/12 px-10">ID</th>
                        <th class="w-5/12 px-10">Name</th>
                        <th class="w-3/12 px-10">Code</th>
                ...
                <tbody>
                    @foreach ($courses as $course)
                         <tr class="text-center">
                         <td  class="w-1/12 px-10">{{$course->id}}</td>
                        <td  class="w-5/12 ">{{$course->name}}</td>
                        <td  class="w-3/12">{{$course->code}}</td>
                        <td  class="w-3/12 px-10 ">
                            <div class="flex">
